...
if __name__ == "__main__":
    ...
    print("\nEste é um protótipo expandido da extensão numba.opencl")
    print("Nem todas as funcionalidades estão totalmente implementadas.")
    print("Para uso em produção, seria necessário implementar a integração completa com o compilador Numba.")
